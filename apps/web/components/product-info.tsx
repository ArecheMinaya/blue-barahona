    ...
    <section className="bg-[var(--color-surface-container-lowest)] px-6 py-10 md:px-12 lg:px-20">
      <div className="mx-auto max-w-xl">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="rounded-[1.25rem] bg-white/80 px-4 py-3">
              ...
              <div className="mt-2 flex items-center gap-3">
                <button
                  type="button"
                  className="flex h-8 w-8 items-center justify-center rounded-full bg-[var(--color-surface-container-low)] text-[var(--color-primary)]"
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2">
          <div className="rounded-[1.5rem] bg-[var(--color-surface)] p-5">
            <span className="label-caps">Craftsmanship</span>
            <p className="mt-3 text-sm leading-7 text-[var(--color-on-surface-variant)]">
              {product.craftNote}
            </p>
          </div>
          <div className="rounded-[1.5rem] bg-[var(--color-surface)] p-5">
            <span className="label-caps">Editorial Story</span>
            <p className="mt-3 text-sm leading-7 text-[var(--color-on-surface-variant)]">
              {product.story}
            </p>
          </div>
